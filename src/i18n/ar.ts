...
export const ar: Translations = {
  ...
  timelinePage: {
    ...
    waybackTooltip: "التنقل خلال ١٨٦ إصدارًا من صور الأقمار الصناعية التاريخية من ٢٠١٤-٢٠٢٥. يمثل كل خط رمادي تاريخ التقاط صورة واحدة. انقر في أي مكان على الجدول الزمني للانتقال إلى ذلك التاريخ. مرر مؤشر الماوس فوق الخطوط الرمادية لرؤية التواريخ الدقيقة.",
  },
