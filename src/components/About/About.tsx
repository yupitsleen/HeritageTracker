      ...
      <div className="p-4 md:p-8 max-w-4xl mx-auto">
        ...
        <section className="border-t border-gray-200 pt-4 md:pt-6">
          <p className="text-[10px] md:text-xs text-gray-500 leading-relaxed mb-3">
            ...
            information are original syntheses created by combining factual data from multiple verified
            sources. Research was conducted using publicly available reports from UNESCO, Forensic
            Architecture, Heritage for Peace, and other authoritative organizations. All factual claims
            (dates, coordinates, artifact counts, destruction dates) are cross-referenced against multiple
            sources and cited accordingly. Narrative descriptions are original summaries of publicly
            available information, not direct quotations. Research assistance provided by Claude (Anthropic).
          </p>
