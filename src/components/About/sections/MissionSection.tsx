...
export function MissionSection() {
  ...
  return (
    <section className="mb-6 md:mb-8">
      <h2 className={`text-xl md:text-2xl font-bold ${isDark ? "text-gray-100" : "text-gray-900"} mb-3 md:mb-4`}>Mission</h2>
      <p className={`text-sm md:text-base ${isDark ? "text-gray-300" : "text-gray-700"} leading-relaxed mb-3 md:mb-4`}>
      ...
      <div className={`${isDark ? "bg-gray-700/50" : "bg-gray-50"} border-l-4 border-[#009639] p-3 md:p-4 rounded`}>
        <p className={`text-xs md:text-base ${isDark ? "text-gray-200" : "text-gray-800"} font-medium`}>
