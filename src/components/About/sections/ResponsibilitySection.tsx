...
export function ResponsibilitySection() {
  ...
  return (
    <section className="mb-8">
      <h2 className={`text-3xl font-bold  mb-4 ${isDark ? "text-white" : "text-gray-900"}`}>Who's Responsible</h2>

      {/* Israeli Military Operations */}
      <div className={`${t.bg.tertiary} rounded-lg p-6 mb-4`}>
        <h3 className={`text-xl font-bold  mb-3 ${isDark ? "text-white" : "text-gray-900"}`}>Israel</h3>
        <div className={`space-y-3 text-base  ${isDark ? "text-white" : "text-gray-900"}`}>
          <p>
          ...
          <div className="border-l-4 border-[#ed3039] pl-4 my-3">
            ...
            <ul className={`list-disc list-inside space-y-1 text-sm  ${isDark ? "text-white" : "text-gray-900"}`}>
      ...
      <div className={`${t.bg.tertiary} rounded-lg p-6`}>
        <h3 className={`text-xl font-bold  mb-3 ${isDark ? "text-white" : "text-gray-900"}`}>United States</h3>
        <div className={`space-y-3 text-base  ${isDark ? "text-white" : "text-gray-900"}`}>
          <p>
