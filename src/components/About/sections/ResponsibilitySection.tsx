...
export function ResponsibilitySection() {
  ...
  return (
    <section className="mb-8">
      <h2 className="text-3xl font-bold text-gray-900 mb-4">Who's Responsible</h2>

      {/* Israeli Military Operations */}
      <div className={`${t.bg.tertiary} rounded-lg p-6 mb-4`}>
        <h3 className="text-xl font-bold text-gray-900 mb-3">Israel</h3>
      ...
      <div className={`${t.bg.tertiary} rounded-lg p-6`}>
        <h3 className="text-xl font-bold text-gray-900 mb-3">United States</h3>
        <div className="space-y-3 text-base text-gray-900">
          <p>
