...
export function ContributingSection() {
  ...
  return (
    <section className="mb-6 md:mb-8">
      <h2 className={`text-xl md:text-2xl font-bold ${t.text.heading} mb-3 md:mb-4`}>
        How to Contribute
      </h2>
      <p className={`text-xs md:text-base ${t.text.body} leading-relaxed mb-3 md:mb-4`}>
        We welcome contributions from researchers, cultural heritage experts, software
        developers, and community members:
      </p>
      <ul className={`list-disc list-inside text-xs md:text-base ${t.text.body} space-y-1 md:space-y-2`}>
        <li>
      ...
      <p className={`text-xs md:text-sm ${t.text.muted} mt-3 md:mt-4`}>
        Contact:{" "}
        <a
