...
export function DataSourcesSection() {
  ...
  return (
    <section className="mb-6 md:mb-8">
      <h2 className={`text-xl md:text-2xl font-bold ${t.text.heading} mb-3 md:mb-4`}>Data Sources</h2>
      <div className="space-y-3 md:space-y-4">
        <div className={`border ${t.border.default} rounded-lg p-3 md:p-4`}>
          <h3 className={`text-sm md:text-base font-bold ${t.text.heading} mb-1 md:mb-2`}>UNESCO</h3>
          <p className={`text-xs md:text-sm ${t.text.body} leading-relaxed`}>
        ...
        <div className={`border ${t.border.default} rounded-lg p-3 md:p-4`}>
          <h3 className={`text-sm md:text-base font-bold ${t.text.heading} mb-1 md:mb-2`}>
