...
export function DataSourcesSection() {
  ...
  return (
    <section className="mb-6 md:mb-8">
      <h2 className={`text-xl md:text-2xl font-bold ${isDark ? "text-gray-100" : "text-gray-900"} mb-3 md:mb-4`}>Data Sources</h2>
      <div className="space-y-3 md:space-y-4">
        <div className={`border ${isDark ? "border-gray-700" : "border-gray-200"} rounded-lg p-3 md:p-4`}>
          <h3 className={`text-sm md:text-base font-bold ${isDark ? "text-gray-100" : "text-gray-900"} mb-1 md:mb-2`}>UNESCO</h3>
        ...
        <div className={`border ${isDark ? "border-gray-700" : "border-gray-200"} rounded-lg p-3 md:p-4`}>
          <h3 className={`text-sm md:text-base font-bold ${isDark ? "text-gray-100" : "text-gray-900"} mb-1 md:mb-2`}>
