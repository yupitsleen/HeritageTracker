...
export function StatsDashboard({ sites }: StatsDashboardProps) {
  // Calculate impactful statistics
  const stats = useMemo(() => {
    ...
    const museumsDestroyed = museums > 0 ? sites.filter((s) => s.type === "museum" && s.status === "destroyed").length : 0;

    // Archaeological sites
    const archaeological = sites.filter((s) => s.type === "archaeological").length;
    const archaeologicalSurviving = sites.filter((s) => s.type === "archaeological" && s.status !== "destroyed").length;
      ...
      <div className="p-4 md:p-8 max-w-6xl mx-auto">
        ...
        <section className="hidden md:block mb-8">
          ...
          <div className="space-y-4">
            <div className="bg-gray-50 border-l-4 border-[#ca8a04] p-4 rounded-r-lg">
        ...
        <section className="hidden md:block mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div className="bg-yellow-50 border-2 border-[#ca8a04] rounded-lg p-4 text-center">
            ...
            <div className="bg-green-50 border-2 border-[#009639] rounded-lg p-4 text-center">
          ...
          <div className="space-y-3">
            ...
            <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-r-lg">
              <h3 className="font-bold text-gray-900 mb-1">Tell el-Ajjul (Damaged)</h3>
              <p className="text-sm text-gray-700 mb-2">
          ...
          <div className="bg-[#009639]/10 border-2 border-[#009639] rounded-lg p-6 mt-6">
            <p className="text-gray-800 font-semibold mb-2">Why This Matters Now:</p>
        ...
        <section className="hidden md:block mb-8">
          ...
          <div className="bg-[#009639]/10 border-l-4 border-[#009639] rounded-lg p-6 space-y-4">
            ...
            <p className="text-gray-800 pt-3 font-semibold">
