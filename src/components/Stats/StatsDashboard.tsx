    ...
    <div className={`max-h-[80vh] overflow-y-auto ${t.bg.primary}`}>
      <div className="p-4 md:p-8 max-w-6xl mx-auto">
        ...
        <section className="mb-6 md:mb-8">
          <h2 className={`text-xl md:text-2xl font-bold ${t.text.heading} mb-3 md:mb-4`}>What Humanity Has Lost</h2>
          <div className="space-y-3 md:space-y-4">
            {/* Great Omari Mosque */}
            <div className={`border-l-4 border-[#ed3039] ${t.bg.tertiary} p-3 md:p-4 rounded-r-lg`}>
              <h3 className={`text-sm md:text-base font-bold ${t.text.heading} mb-1`}>Great Omari Mosque</h3>
        ...
        {/* Looted Artifacts */}
        <section className="mb-6 md:mb-8">
          <h2 className={`text-xl md:text-2xl font-bold ${t.text.heading} mb-3 md:mb-4`}>Looted Artifacts</h2>
          <p className={`text-xs md:text-sm ${t.text.body} mb-3 md:mb-4`}>
          ...
          <div className={`${isDark ? "bg-purple-900/20" : "bg-purple-50"} border-2 border-purple-600 rounded-lg p-4 md:p-6 mb-4`}>
            <div className="flex items-start gap-4">
              <div className="flex-shrink-0">
                ...
                <div className={`text-xs md:text-sm font-semibold ${t.text.heading}`}>
                  Artifacts Looted
                </div>
              </div>
              <div className={`flex-1 text-xs md:text-sm ${t.text.body} space-y-2`}>
                <p>
          ...
          {/* Legal context */}
          <div className={`${t.bg.tertiary} border-l-4 border-purple-600 p-3 md:p-4 rounded-r-lg`}>
            <p className={`text-xs md:text-sm ${t.text.subheading} mb-2`}>
              <strong>International Law:</strong>
            </p>
            <ul className={`text-xs ${t.text.body} space-y-1 list-disc list-inside`}>
              <li>
        ...
        {isDesktop && (
          ...
          <div className="space-y-4">
            <div className={`${t.bg.tertiary} border-l-4 border-[#ca8a04] p-4 rounded-r-lg`}>
              <h3 className={`font-bold ${t.text.heading} mb-2 flex items-center gap-2`}>
              ...
              <p className={`text-xs ${t.text.muted} italic`}>
        ...
        {isDesktop && (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div className={`${isDark ? "bg-yellow-900/20" : "bg-yellow-50"} border-2 border-[#ca8a04] rounded-lg p-4 text-center`}>
              ...
              <div className={`text-sm font-semibold ${t.text.heading} mb-2`}>
          ...
          <div className="space-y-3">
            ...
            <div className={`${isDark ? "bg-blue-900/20" : "bg-blue-50"} border-l-4 border-blue-500 p-4 rounded-r-lg`}>
              <h3 className={`font-bold ${t.text.heading} mb-1`}>Tell el-Ajjul (Damaged)</h3>
              <p className={`text-sm ${t.text.body} mb-2`}>
        ...
        {isDesktop && (
          ...
          <div className="bg-[#009639]/10 border-l-4 border-[#009639] rounded-lg p-6 space-y-4">
            ...
            <ul className={`space-y-3 text-sm ${t.text.body}`}>
        ...
        {/* Legal Context */}
        <section className="mb-6 md:mb-8">
          <h2 className={`text-xl md:text-2xl font-bold ${t.text.heading} mb-3 md:mb-4`}>Legal Framework</h2>
          <div className={`${t.bg.tertiary} border ${t.border.default} rounded-lg p-4 md:p-6 space-y-2 md:space-y-3 text-xs md:text-sm ${t.text.body}`}>
            <p>
