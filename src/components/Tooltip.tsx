...
export function Tooltip({ content, children }: TooltipProps) {
  ...
  const tooltipContent = isVisible && (
    <div
      ref={tooltipRef}
      className="px-3 py-2 bg-gray-900 text-white text-xs rounded-md shadow-lg max-w-[18rem] break-words text-center"
      style={{
        position: 'fixed',
        top: `${position.top}px`,
        ...
        minWidth: '160px', // Prevent tooltip from becoming too narrow (tall and skinny)
      }}
    >
      {content}
      <div
